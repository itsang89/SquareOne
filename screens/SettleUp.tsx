                ...
                <div className="border-t-2 border-black pt-4 mt-2">
                    <div className="flex justify-between items-end">
                        <div>
                            ...
                            <p className="text-4xl font-black mt-1">{formatCurrency(Math.abs(balance))}</p>
                        </div>
                ...
                <label className="block">
                    ...
                    <div className="relative mt-2">
                        ...
                        <input 
                            ...
                            className="w-full h-20 bg-white border-2 border-black pl-10 pr-24 text-5xl font-black focus:outline-none focus:shadow-neo-lg focus:bg-white transition-all placeholder:text-gray-300"
                        />
                        <button 
                          onClick={handleMax}
                          disabled={isSubmitting}
                          className="absolute right-3 top-1/2 -translate-y-1/2 text-xs font-bold uppercase bg-neo-yellow px-3 py-1 border-2 border-black hover:bg-yellow-300 hover:shadow-sm transition-all disabled:opacity-50"
                        >
                            Max
                        </button>
                    </div>
                ...
                <div className="grid grid-cols-3 gap-3">
                    {['100', '500', 'Full'].map(val => (
                      <button 
                        ...
                        disabled={isSubmitting}
                        className={`h-10 border-2 border-black font-bold text-sm shadow-neo-sm active:shadow-none active:translate-y-1 transition-all hover:bg-blue-50 disabled:opacity-50 ${
                    ...
                    <label className="block">
                        ...
                        <div className="relative mt-1">
                            <button 
                              ...
                              disabled={isSubmitting}
                              className="w-full h-12 bg-white border-2 border-black px-3 text-left text-base font-bold focus:outline-none focus:shadow-neo transition-all flex items-center justify-between disabled:opacity-50"
                            >
